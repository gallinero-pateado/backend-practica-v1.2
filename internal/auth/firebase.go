...
// @Summary Inicializa Firebase
// @Description Inicializa Firebase utilizando un archivo de credenciales especificado
// @Tags firebase
// @Success 200 {string} string "Firebase inicializado correctamente"
// @Failure 500 {object} ErrorResponse "Error inicializando Firebase"
// @Router /init_firebase [get]
